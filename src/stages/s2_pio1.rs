...
impl Stage for Stage2 {
    ...
    fn do_twist(self, twist: Twist) -> Self {
        ...
        let e_op = crate::lut::update_orientations_u64(e_op, {
            static LUT: [[u64; 3]; 184] = [
                [0x0, 0xFFFF33FF33FF33FF, 0xCC00CC00CC00],
                [0x0, 0xFFFFCCFFCCFFCCFF, 0x330033003300],
                [0x0, 0xFF7FFF7FFF7FFF7F, 0xC0A0C050C0A0C0],
                [0x0, 0xFFFFFAFFFFFFFAFF, 0x10F010A010F01],
                [0x0, 0xFF3CFFFFAA3CFFFF, 0xEB0000FFEB0000],
                [0x0, 0xFFFFFFD7FFFFFFD7, 0xBE000000BE],
                [0x0, 0xFFFFFFFFFFFFFFFF, 0x55005500000000],
                [0x0, 0xFFFFFFFFFFFFFFFF, 0x145514],
                [0x0, 0xFFCFFFCFFFCFFFCF, 0x30003000300030],
                [0x0, 0xFFF3FFF3FFF3FFF3, 0xC000C000C000C],
                [0x0, 0xFF7FFF7FFF7FFF7F, 0xC0A0C050C0A0C0],
                [0x0, 0xFFFDFFFDFFFDFFFD, 0x30A0305030A03],
                [0x0, 0xFF3CFFFFAA3CFFFF, 0xEB0000FFEB0000],
                [0x0, 0xFFFFFF3CFFFFFF3C, 0xEB000000EB],
                [0x0, 0xFFFFFFFFFFFFFFFF, 0x14551400000000],
                [0x0, 0xFFFFFFFFFFFFFFFF, 0x555555],
                [0x0, 0xFFCF33CFFFCF33CF, 0x30CC300030CC30],
                [0x0, 0xFFF3FFF3FFF3FFF3, 0xC000C000C000C],
                [0x0, 0xFFFFFFFFFFFFFFFF, 0x405040A0405040],
                [0x0, 0xFFFDFFFDFFFDFFFD, 0x30A0305030A03],
                [0x0, 0xFF7DFFFFAA7DFFFF, 0xEB0000FFEB0000],
                [0x0, 0xFFFFFF3CFFFFFF3C, 0xEB000000EB],
                [0x0, 0xFFFFFFFFFFFFFFFF, 0x14551400000000],
                [0x0, 0xFFFFFFFFFFFFFFFF, 0x550055],
                [0x0, 0xFFCF33CFFFCF33CF, 0x30CC300030CC30],
                [0x0, 0xFFF3CCF3FFF3CCF3, 0xC330C000C330C],
                [0x0, 0xFFFFAFFFFFFFAFFF, 0x40F040A040F040],
                [0x0, 0xFFFDFFFDFFFDFFFD, 0x30A0305030A03],
                [0x0, 0xFFFFFFFFFFFFFFFF, 0x55000000],
                [0x0, 0xFFFFFF3CFFFFFF3C, 0xEB000000EB],
                [0x0, 0xFFFFFFFFFFFFFFFF, 0x14551400000000],
                [0x0, 0xFFFFFFFFFFFFFFFF, 0x550055],
                [0x0, 0xFFCF33CFFFCF33CF, 0x30CC300030CC30],
                ...
                [0x0, 0xFFFFAFFFFFFFAFFF, 0x40F040A040F040],
                [0x0, 0xFFFDFFFDFFFDFFFD, 0x30A0305030A03],
                [0x0, 0xFFD7FFFF00D7FFFF, 0xBE0000FFBE0000],
                [0x0, 0xFFFFFF3CFFFFFF3C, 0xEB000000EB],
                [0x0, 0xFFFFFFFFFFFFFFFF, 0x55555500000000],
                [0x0, 0xFFFFFFFFFFFFFFFF, 0x550055],
                [0x0, 0xFFCFFFCFFFCFFFCF, 0x30003000300030],
                [0x0, 0xFFF3CCF3FFF3CCF3, 0xC330C000C330C],
                [0x0, 0xFFFFAFFFFFFFAFFF, 0x40F040A040F040],
                [0x0, 0xFFFCFFFCFFFCFFFC, 0x3000300030003],
                [0x0, 0xFFD7FFFF00D7FFFF, 0xBE0000FFBE0000],
                [0x0, 0xFFFFFF7DFFFFFF7D, 0xEB000000EB],
                [0x0, 0xFFFFFFFFFFFFFFFF, 0x55555500000000],
                [0x0, 0xFFFFFFFFFFFFFFFF, 0x555555],
                [0x0, 0xFFFFFFFF33FFFFFF, 0xCC000000],
                [0x0, 0xFFF3CCF3FFF3CCF3, 0xC330C000C330C],
                [0x0, 0xFF3FFF3FFF3FFF3F, 0xC000C000C000C0],
                [0x0, 0xFFFCFFFCFFFCFFFC, 0x3000300030003],
                [0x0, 0xFFD7FFFF00D7FFFF, 0xBE0000FFBE0000],
                [0x0, 0xFFFFFF7DFFFFFF7D, 0xEB000000EB],
                [0x0, 0xFFFFFFFFFFFFFFFF, 0x0],
                [0x0, 0xFFFFFFFFFFFFFFFF, 0x410041],
                [0x0, 0xFFFF33FF33FF33FF, 0xCC00CC00CC00],
                [0x0, 0xFFF3FFF3FFF3FFF3, 0xC000C000C000C],
                [0x0, 0xFFFFFFFFFFFFFFFF, 0x405040A0405040],
                [0x0, 0xFFFFFFFFFFFFFFFF, 0x105010A010501],
                [0x0, 0xFF7DFFFFAA7DFFFF, 0xEB0000FFEB0000],
                [0x0, 0xFFFFFFFFFFFFFFFF, 0x0],
                [0x0, 0xFFFFFFFFFFFFFFFF, 0x55555500000000],
                [0x0, 0xFFFFFFFFFFFFFFFF, 0x145514],
                [0x0, 0xFFFF33FF33FF33FF, 0xCC00CC00CC00],
                [0x0, 0xFFFFFFFFCCFFFFFF, 0x33000000],
                [0x0, 0xFF7FFF7FAF7FFF7F, 0xC0A0C0F0C0A0C0],
                [0x0, 0xFFFFFFFFFFFFFFFF, 0x105010A010501],
                [0x0, 0xFFFFFFFFFFFFFFFF, 0x55000000],
                [0x0, 0xFFFFFFFFFFFFFFFF, 0x0],
                [0x0, 0xFFFFFFFFFFFFFFFF, 0x550000000000],
                [0x0, 0xFFFFFFFFFFFFFFFF, 0x145514],
                [0x0, 0xFFCFFFCFFFCFFFCF, 0x30003000300030],
                [0x0, 0xFFFFFFFFCCFFFFFF, 0x33000000],
                [0x0, 0xFF3FFF3FFF3FFF3F, 0xC000C000C000C0],
                [0x0, 0xFFFFFFFFFFFFFFFF, 0x0],
                [0x0, 0xFFC3FFFF00C3FFFF, 0xBE0000FFBE0000],
                [0x0, 0xFFFFFFFFFFFFFFFF, 0x0],
                [0x0, 0xFFFFFFFFFFFFFFFF, 0x55555500000000],
                [0x0, 0xFFFFFFFFFFFFFFFF, 0x555555],
                [0x0, 0xFFFFFFFF33FFFFFF, 0xCC000000],
                ...
                [0x0, 0xFFFFFFFFFFFFFFFF, 0x55005500000000],
                [0x0, 0xFFFFFFFFFFFFFFFF, 0x0],
                [0x0, 0xFFCF33CF33CF33CF, 0x30CC30CC30CC30],
                [0x0, 0xFFF3FFF3FFF3FFF3, 0xC000C000C000C],
                [0x0, 0xFF3FFF3FFF3FFF3F, 0xC000C000C000C0],
                [0x0, 0xFFFCFFFCFFFCFFFC, 0x3000300030003],
                [0x0, 0xFF7DFFFFAA7DFFFF, 0xEB0000FFEB0000],
                ...
                [0x0, 0xFFFFFFFFFFFFFFFF, 0x55000000],
                [0x0, 0xFFFFFFFFFFFFFFFF, 0x0],
                [0x0, 0xFFFFFFFFFFFFFFFF, 0x41004100000000],
                [0x0, 0xFFFFFFFFFFFFFFFF, 0x555555],
                [0x0, 0xFFCF33CFFFCF33CF, 0x30CC300030CC30],
                [0x0, 0xFFFFFFFFCCFFFFFF, 0x33000000],
                [0x0, 0xFF7FFF7FAF7FFF7F, 0xC0A0C0F0C0A0C0],
                ...
                [0x0, 0xFFFFFFFFFFFFFFFF, 0x0],
                [0x0, 0xFFFFFFFF33FFFFFF, 0xCC000000],
                [0x0, 0xFFF3CCF3CCF3CCF3, 0xC330C330C330C],
                [0x0, 0xFFFFFFFFFFFFFFFF, 0x405040A0405040],
                [0x0, 0xFFFDFFFDFAFDFFFD, 0x30A030F030A03],
                [0x0, 0xFFFFFFFFFFFFFFFF, 0x55000000],
                [0x0, 0xFFFFFFC3FFFFFFC3, 0xBE000000BE],
                [0x0, 0xFFFFFFFFFFFFFFFF, 0x41004100000000],
                [0x0, 0xFFFFFFFFFFFFFFFF, 0x410041],
                [0x0, 0xFFFF33FF33FF33FF, 0xCC00CC00CC00],
                [0x0, 0xFFF3CCF3CCF3CCF3, 0xC330C330C330C],
        ...
        let e_op = apply_permutation_lut!(u64, e_op, twist, [
            4 => [(&0xFF00FFFF0000FFFF<<0)|(&0x30000000000000<<2)|(&0xC00000<<4)|(&0x30000<<8)|(&0xC0000000<<22)|(&0xC000000<<24)|(&0x300000<<28)|(&0xC000000000000<<36)|(&0xC0000000000000<<40)|(&0x3000000000000<<44)|(&0x30000000<<56)|(&0x3000000<<58)|(&0xC0000<<62)],
            6 => [(&0xFF000000FFFFFFFF<<0)|(&0xC00000000000<<2)|(&0x300000000<<4)|(&0x3000000000<<6)|(&0x300000000000<<10)|(&0xC00000000<<12)|(&0xC000000000<<14)|(&0x3000000000000<<50)|(&0x30000000000000<<52)|(&0xC0000000000<<54)|(&0xC000000000000<<58)|(&0xC0000000000000<<60)|(&0x30000000000<<62)],
            7 => [(&0xFFFFFFFFFF000000<<0)|(&0xC0<<2)|(&0xC0000<<4)|(&0x3000<<6)|(&0x3<<10)|(&0x300<<12)|(&0xC<<14)|(&0x300000<<50)|(&0xC000<<52)|(&0xC00000<<54)|(&0xC00<<58)|(&0x30<<60)|(&0x30000<<62)],
            12 => [(&0xFF00FFFF0000FFFF<<0)|(&0xC00000<<2)|(&0xC000000000000<<4)|(&0x30000<<10)|(&0x30000000<<22)|(&0x3000000<<28)|(&0xC0000<<30)|(&0x30000000000000<<34)|(&0xC0000000000000<<38)|(&0x3000000000000<<46)|(&0xC0000000<<52)|(&0xC000000<<58)|(&0x300000<<60)],
            14 => [(&0xFF000000FFFFFFFF<<0)|(&0x30000000000000<<2)|(&0xC000000000<<4)|(&0xC00000000000<<6)|(&0xC0300000000<<8)|(&0x3000000000<<12)|(&0xC000000000000<<52)|(&0xC0300000000000<<56)|(&0x30000000000<<58)|(&0x3000000000000<<60)|(&0xC00000000<<62)],
            15 => [(&0xFFFFFFFFFF000000<<0)|(&0xC<<2)|(&0xC00<<6)|(&0xC0C0<<8)|(&0x3<<10)|(&0x30<<16)|(&0xC0000<<48)|(&0xC00000<<54)|(&0x30300<<56)|(&0x3000<<58)|(&0x300000<<62)],
            20 => [(&0xFF00FFFF0000FFFF<<0)|(&0xC0000<<2)|(&0xC00000<<8)|(&0x30000<<10)|(&0xC000000<<22)|(&0xC0000000<<24)|(&0xC000000300000<<32)|(&0xC0000000000000<<38)|(&0x3000000000000<<40)|(&0x3000000<<56)|(&0x30000000<<58)|(&0x30000000000000<<62)],
            22 => [(&0xFF000000FFFFFFFF<<0)|(&0x3000000000<<2)|(&0x30C000000000<<8)|(&0x30000000000<<10)|(&0x300000000<<12)|(&0xC00000000<<20)|(&0x30000000000000<<44)|(&0xC0000000000000<<52)|(&0xC00000000000<<54)|(&0x30C0000000000<<56)|(&0xC000000000000<<62)],
            23 => [(&0xFFFFFFFFFF000000<<0)|(&0x30000<<2)|(&0x30C<<8)|(&0x30<<10)|(&0xC00<<12)|(&0x3<<20)|(&0xC00000<<44)|(&0x3000<<52)|(&0xC0000<<54)|(&0x30C000<<56)|(&0xC0<<62)],
            28 => [(&0xFF00FFFF0000FFFF<<0)|(&0x3000030030000<<2)|(&0xC0000030C0000<<4)|(&0x300000C0300000<<60)|(&0xC000000CC00000<<62)],
            30 => [(&0xFF000000FFFFFFFF<<0)|(&0xC00C00000000<<4)|(&0xC000000000<<6)|(&0xC0000000000<<10)|(&0x300000000<<14)|(&0x3000000000<<18)|(&0xC000000000000<<46)|(&0xC0000000000000<<50)|(&0x300000000000<<54)|(&0x3000000000000<<58)|(&0x30030000000000<<60)],
            31 => [(&0xFFFFFFFFFF000000<<0)|(&0x3<<2)|(&0x3000<<4)|(&0xC<<6)|(&0xC030<<8)|(&0xC0<<12)|(&0x30000<<52)|(&0xC0300<<56)|(&0x300000<<58)|(&0xC00<<60)|(&0xC00000<<62)],
            36 => [(&0xFF00FFFF0000FFFF<<0)|(&0x3000000300000<<4)|(&0xC0000<<10)|(&0xC000000<<22)|(&0xC0000003000000<<30)|(&0x30000<<34)|(&0x30000000000000<<38)|(&0xC000000000000<<44)|(&0xC0000000<<50)|(&0x30000000<<58)|(&0xC00000<<60)],
            38 => [(&0xFF0C0030FFFFFFFF<<0)|(&0x30C000000000<<4)|(&0x30300000000<<14)|(&0xC00000000<<18)|(&0x30000000000000<<46)|(&0xC0C00000000000<<50)|(&0x30C0000000000<<60)],
            39 => [(&0xFFFFFFFFFF000000<<0)|(&0x30030<<4)|(&0xC00<<6)|(&0xC<<10)|(&0x300<<14)|(&0x3<<18)|(&0xC00000<<46)|(&0xC000<<50)|(&0x300000<<54)|(&0x3000<<58)|(&0xC00C0<<60)],
            44 => [(&0xFF00FFFF0000FFFF<<0)|(&0x3000000000000<<2)|(&0xC0000<<8)|(&0x300000<<10)|(&0x3000000<<24)|(&0xC000000C000000<<28)|(&0x30000<<36)|(&0xC000000000000<<38)|(&0x30000000000000<<40)|(&0x30000000<<52)|(&0xC0000000<<56)|(&0xC00000<<62)],
            46 => [(&0xFF30000CFFFFFFFF<<0)|(&0xC0C000000000<<2)|(&0xC0300000000<<12)|(&0x3000000000<<14)|(&0xC000000000000<<50)|(&0xC0300000000000<<52)|(&0x3030000000000<<62)],
            47 => [(&0xFFFFFFFFFF30000C<<0)|(&0xC0C0<<2)|(&0xC03<<12)|(&0x30<<14)|(&0xC0000<<50)|(&0xC03000<<52)|(&0x30300<<62)],
            52 => [(&0xFF00FFFF0000FFFF<<0)|(&0x30000<<2)|(&0xC0000<<6)|(&0x300000<<8)|(&0x30000000<<20)|(&0xC0000000<<24)|(&0xC00000<<28)|(&0x3000000000000<<36)|(&0xC000000000000<<40)|(&0x30000000000000<<42)|(&0x3000000<<56)|(&0xC000000<<60)|(&0xC0000000000000<<62)],
            54 => [(&0xFF000000FFFFFFFF<<0)|(&0x330000000000<<2)|(&0x3000000000<<14)|(&0xC300000000<<16)|(&0xC00000000<<18)|(&0x30000000000000<<46)|(&0xC3000000000000<<48)|(&0xC000000000000<<50)|(&0xCC0000000000<<62)],
            55 => [(&0xFFFFFFFFFF000000<<0)|(&0x3003C<<6)|(&0xF00<<10)|(&0x3<<16)|(&0xC00000<<48)|(&0xF000<<54)|(&0x3C00C0<<58)],
            60 => [(&0xFF30FFFF000CFFFF<<0)|(&0xC00000<<2)|(&0x30000<<12)|(&0xC0000000<<18)|(&0xC000000<<28)|(&0x300000<<30)|(&0xC000000000000<<34)|(&0xC0000000000000<<36)|(&0x3000000000000<<46)|(&0x30000000<<52)|(&0x3000000<<62)],
            61 => [(&0xFFFFFF00FFFFFF00<<0)|(&0xF0000000F0<<28)|(&0xF0000000F<<36)],
            62 => [(&0xFF000000FFFFFFFF<<0)|(&0xC000000000000<<2)|(&0xC000000000<<6)|(&0x30300000000<<8)|(&0x300000000000<<10)|(&0xC00000000<<16)|(&0x30000000000000<<48)|(&0xC0000000000<<54)|(&0xC0C00000000000<<56)|(&0x3000000000000<<58)|(&0x3000000000<<62)],
            63 => [(&0xFFFFFFFFFF000000<<0)|(&0xC00C<<4)|(&0xC0<<6)|(&0xC00<<10)|(&0x3<<14)|(&0x30<<18)|(&0xC0000<<46)|(&0xC00000<<50)|(&0x3000<<54)|(&0x30000<<58)|(&0x300300<<60)],
            68 => [(&0xFF00FFFFC300FFFF<<0)|(&0xC000000<<2)|(&0xCC000000CC0000<<30)|(&0x33000000330000<<34)|(&0x30000000<<62)],
            69 => [(&0xFFFFFF00FFFFFF00<<0)|(&0xCC000000CC<<30)|(&0x3300000033<<34)],
            70 => [(&0xFF000000FFFFFFFF<<0)|(&0x3300300000000<<2)|(&0xC030C00000000<<4)|(&0x30C03000000000<<60)|(&0xC00CC000000000<<62)],
            71 => [(&0xFFFFFFFFFF000000<<0)|(&0x30<<2)|(&0x30C0<<8)|(&0x300<<10)|(&0x3<<12)|(&0xC<<20)|(&0x300000<<44)|(&0xC00000<<52)|(&0xC000<<54)|(&0x30C00<<56)|(&0xC0000<<62)],
            76 => [(&0xFF00FFFF0000FFFF<<0)|(&0x30000003C0000<<6)|(&0xF000000<<26)|(&0xC0000000030000<<32)|(&0x3C000000000000<<42)|(&0xF0000000<<54)|(&0xC00000<<58)],
            77 => [(&0xFFFFFF00FFFFFF00<<0)|(&0x3000000030<<30)|(&0xC3000000C3<<32)|(&0xC0000000C<<34)],
            78 => [(&0xFF000000FFFFFFFF<<0)|(&0xC00000000<<2)|(&0xC0000000000<<6)|(&0xC0C000000000<<8)|(&0x300000000<<10)|(&0x3000000000<<16)|(&0xC000000000000<<48)|(&0xC0000000000000<<54)|(&0x3030000000000<<56)|(&0x300000000000<<58)|(&0x30000000000000<<62)],
            79 => [(&0xFFFFFFFFFF0C0030<<0)|(&0x30C0<<4)|(&0x303<<14)|(&0xC<<18)|(&0x300000<<46)|(&0xC0C000<<50)|(&0x30C00<<60)],
            84 => [(&0xFF00FFFF0000FFFF<<0)|(&0x300000<<2)|(&0xC00000<<8)|(&0x30000<<12)|(&0x30000000<<24)|(&0x3000000<<26)|(&0x30000000000000<<28)|(&0xC00000000C0000<<36)|(&0x3000000000000<<40)|(&0xC0000000<<54)|(&0xC000000<<56)|(&0xC000000000000<<62)],
            85 => [(&0xFFFFFF00FFFFFF00<<0)|(&0xC0000000C<<2)|(&0x300000003<<6)|(&0xC0000000C0<<58)|(&0x3000000030<<62)],
            86 => [(&0xFF000000FFFFFFFF<<0)|(&0x3003000000000<<4)|(&0xC0000000000<<6)|(&0xC00000000<<10)|(&0x30000000000<<14)|(&0x300000000<<18)|(&0xC0000000000000<<46)|(&0xC00000000000<<50)|(&0x30000000000000<<54)|(&0x300000000000<<58)|(&0xC00C000000000<<60)],
            87 => [(&0xFFFFFFFFFF0300C0<<0)|(&0xC30<<8)|(&0x30C<<12)|(&0x3<<22)|(&0xC00000<<42)|(&0x30C000<<52)|(&0xC3000<<56)],
            92 => [(&0xFF00FFFF0000FFFF<<0)|(&0xC0000<<4)|(&0xC00000<<6)|(&0x30000<<14)|(&0xC0000000<<20)|(&0xC000000<<26)|(&0xC000000000000<<30)|(&0xC0000000300000<<34)|(&0x3000000000000<<42)|(&0x30000000<<54)|(&0x30000003000000<<60)],
            94 => [(&0xFF000000FFFFFFFF<<0)|(&0x3000000000000<<2)|(&0x30C00000000<<8)|(&0x3000000000<<10)|(&0xC0000000000<<12)|(&0x300000000<<20)|(&0xC0000000000000<<44)|(&0x300000000000<<52)|(&0xC000000000000<<54)|(&0x30C00000000000<<56)|(&0xC000000000<<62)],
            95 => [(&0xFFFFFFFFFF000000<<0)|(&0x3300<<2)|(&0x30<<14)|(&0xC3<<16)|(&0xC<<18)|(&0x300000<<46)|(&0xC30000<<48)|(&0xC0000<<50)|(&0xCC00<<62)],
            100 => [(&0xFF0CFFFF0030FFFF<<0)|(&0xC00000<<4)|(&0x30000<<14)|(&0x30000000<<20)|(&0x30000003000000<<30)|(&0xC00000000C0000<<34)|(&0x3000000000000<<44)|(&0xC0000000<<50)|(&0xC000000<<60)],
            102 => [(&0xFF000000FFFFFFFF<<0)|(&0x300000000<<2)|(&0x300000000000<<4)|(&0xC00000000<<6)|(&0xC03000000000<<8)|(&0xC000000000<<12)|(&0x3000000000000<<52)|(&0xC030000000000<<56)|(&0x30000000000000<<58)|(&0xC0000000000<<60)|(&0xC0000000000000<<62)],
            103 => [(&0xFFFFFFFFFF000000<<0)|(&0x300330<<2)|(&0x30C03<<4)|(&0xC030C0<<60)|(&0xCC00C<<62)],
            108 => [(&0xFF00FFFF3C00FFFF<<0)|(&0x3000000<<6)|(&0xF0000000F00000<<28)|(&0xF0000000F0000<<36)|(&0xC0000000<<58)],
            109 => [(&0xFFFFFF00FFFFFF00<<0)|(&0x3000000030<<2)|(&0x300000003<<4)|(&0xC0000000C0<<60)|(&0xC0000000C<<62)],
            110 => [(&0xFF0300C0FFFFFFFF<<0)|(&0xC3000000000<<8)|(&0x30C00000000<<12)|(&0x300000000<<22)|(&0xC0000000000000<<42)|(&0x30C00000000000<<52)|(&0xC300000000000<<56)],
            111 => [(&0xFFFFFFFFFF000000<<0)|(&0xC0000<<2)|(&0xC0<<6)|(&0x303<<8)|(&0x3000<<10)|(&0xC<<16)|(&0x300000<<48)|(&0xC00<<54)|(&0xC0C000<<56)|(&0x30000<<58)|(&0x30<<62)],
            116 => [(&0xFF03FFFF00C0FFFF<<0)|(&0x300000<<8)|(&0xC0000<<12)|(&0xC000000<<24)|(&0xC0000000000000<<26)|(&0x3000000<<28)|(&0x30000000000000<<36)|(&0x30000<<38)|(&0xC000000000000<<40)|(&0xC0000000<<52)|(&0x30000000<<56)],
            117 => [(&0xFFFFFF00FFFFFF00<<0)|(&0x300000003<<2)|(&0xC0000000C<<4)|(&0x3000000030<<60)|(&0xC0000000C0<<62)],
            118 => [(&0xFFC00003FFFFFFFF<<0)|(&0xC03000000000<<4)|(&0x300C00000000<<8)|(&0xC000000000<<10)|(&0x3000000000000<<54)|(&0x300C0000000000<<56)|(&0xC030000000000<<60)],
            119 => [(&0xFFFFFFFFFF000000<<0)|(&0xC000<<2)|(&0x3<<4)|(&0x30<<6)|(&0x3000<<10)|(&0xC<<12)|(&0xC0<<14)|(&0x30000<<50)|(&0x300000<<52)|(&0xC00<<54)|(&0xC0000<<58)|(&0xC00000<<60)|(&0x300<<62)],
            124 => [(&0xFF00FFFF0000FFFF<<0)|(&0x33000000<<2)|(&0x30000000300000<<30)|(&0xC3000000C30000<<32)|(&0xC0000000C0000<<34)|(&0xCC000000<<62)],
            126 => [(&0xFF00C300FFFFFFFF<<0)|(&0xC0000000000<<2)|(&0xCC00000000<<14)|(&0x3300000000<<18)|(&0xCC000000000000<<46)|(&0x33000000000000<<50)|(&0x300000000000<<62)],
            127 => [(&0xFFFFFFFFFFC00003<<0)|(&0xC030<<4)|(&0x300C<<8)|(&0xC0<<10)|(&0x30000<<54)|(&0x300C00<<56)|(&0xC0300<<60)],
            132 => [(&0xFF00FFFF0000FFFF<<0)|(&0xC00000C0C0000<<2)|(&0x3000003030000<<6)|(&0xC00000C0C00000<<58)|(&0x30000030300000<<62)],
            134 => [(&0xFF000000FFFFFFFF<<0)|(&0xF0000000000<<4)|(&0xC000000000<<10)|(&0x3C00000000<<16)|(&0x300000000<<22)|(&0xC0000000000000<<42)|(&0x3C000000000000<<48)|(&0x3000000000000<<54)|(&0xF00000000000<<60)],
            135 => [(&0xFFFFFFFFFF003C00<<0)|(&0x300<<6)|(&0xF0<<12)|(&0xF<<20)|(&0xF00000<<44)|(&0xF0000<<52)|(&0xC000<<58)],
            140 => [(&0xFF00FFFF0000FFFF<<0)|(&0xC000000000000<<2)|(&0xC00000<<6)|(&0x30000<<8)|(&0x3000000<<24)|(&0x30000000<<26)|(&0x300000000C0000<<32)|(&0xC0000000000000<<40)|(&0x3000000000000<<42)|(&0xC000000<<54)|(&0xC0000000<<56)|(&0x300000<<62)],
            142 => [(&0xFF000000FFFFFFFF<<0)|(&0x3003C00000000<<6)|(&0xF0000000000<<10)|(&0x300000000<<16)|(&0xC0000000000000<<48)|(&0xF00000000000<<54)|(&0x3C00C000000000<<58)],
            143 => [(&0xFFFFFFFFFF000000<<0)|(&0xF00<<4)|(&0xC0<<10)|(&0x3C<<16)|(&0x3<<22)|(&0xC00000<<42)|(&0x3C0000<<48)|(&0x30000<<54)|(&0xF000<<60)],
            148 => [(&0xFF00FFFF0000FFFF<<0)|(&0x30000003300000<<2)|(&0x300000C030000<<4)|(&0xC0000030C00000<<60)|(&0xC0000C00C0000<<62)],
            150 => [(&0xFF000000FFFFFFFF<<0)|(&0xF00300000000<<6)|(&0x3C00000000<<10)|(&0xC000000000<<16)|(&0x3000000000000<<48)|(&0x3C000000000000<<54)|(&0xC00F0000000000<<58)],
            151 => [(&0xFFFFFFFFFF000000<<0)|(&0xF003<<6)|(&0x3C<<10)|(&0xC0<<16)|(&0x30000<<48)|(&0x3C0000<<54)|(&0xC00F00<<58)],
            156 => [(&0xFF00FFFF0000FFFF<<0)|(&0x30000<<4)|(&0x300000<<6)|(&0xC0000<<12)|(&0xC0000000<<18)|(&0x30000000<<26)|(&0xC00000<<30)|(&0x3000000000000<<34)|(&0x30000000000000<<36)|(&0xC000000000000<<42)|(&0xC000000<<54)|(&0xC0000000000000<<60)|(&0x3000000<<62)],
            158 => [(&0xFF000000FFFFFFFF<<0)|(&0xC000000000<<2)|(&0xC000000000000<<4)|(&0x300000000000<<6)|(&0x300000000<<10)|(&0x30000000000<<12)|(&0xC00000000<<14)|(&0x30000000000000<<50)|(&0xC00000000000<<52)|(&0xC0000000000000<<54)|(&0xC0000000000<<58)|(&0x3000000000<<60)|(&0x3000000000000<<62)],
            159 => [(&0xFFFFFFFFFF000000<<0)|(&0x300000<<2)|(&0xC0<<4)|(&0xC000<<6)|(&0xC03<<8)|(&0x30<<12)|(&0xC0000<<52)|(&0xC03000<<56)|(&0x300<<58)|(&0x30000<<60)|(&0xC<<62)],
            161 => [(&0xFFF3CCF3CCF3CCF3<<0)|(&0x3000000<<4)|(&0x300000003000<<28)|(&0xC000C000C000C<<32)|(&0x30000000300<<36)|(&0x30000000<<60)],
            163 => [(&0xFFFCF0FCF0FCF0FC<<0)|(&0x3000000<<2)|(&0xC0000000C00<<30)|(&0x3000300030003<<32)|(&0x30000000300<<34)|(&0xC000000<<62)],
            164 => [(&0xFFC0FFFF0003FFFF<<0)|(&0x300000<<4)|(&0xC0000<<8)|(&0xC0000000<<20)|(&0x30000000<<24)|(&0xC00000<<26)|(&0x3000000000000<<38)|(&0x30000000000000<<40)|(&0xC000000000000<<44)|(&0xC000000<<56)|(&0x3000000<<60)],
            165 => [(&0xFFFFFF00FFFFFF00<<0)|(&0xC0000000C0<<26)|(&0x3C0000003C<<32)|(&0x300000003<<38)],
            166 => [(&0xFF003C00FFFFFFFF<<0)|(&0x30000000000<<6)|(&0xF000000000<<12)|(&0xF00000000<<20)|(&0xF0000000000000<<44)|(&0xF000000000000<<52)|(&0xC00000000000<<58)],
            167 => [(&0xFFFFFFFFFF00C300<<0)|(&0xC00<<2)|(&0xCC<<14)|(&0x33<<18)|(&0xCC0000<<46)|(&0x330000<<50)|(&0x3000<<62)],
            168 => [(&0xFFCF33CF33CF33CF<<0)|(&0xC000000<<4)|(&0xC0000000C000<<28)|(&0x30003000300030<<32)|(&0xC0000000C00<<36)|(&0xC0000000<<60)],
            170 => [(&0xFF3F0F3F0F3F0F3F<<0)|(&0x30000000<<2)|(&0xC0000000C000<<30)|(&0xC000C000C000C0<<32)|(&0x300000003000<<34)|(&0xC0000000<<62)],
            172 => [(&0xFF00FFFF0000FFFF<<0)|(&0xF000000<<4)|(&0xC0000000C00000<<26)|(&0x3C0000003C0000<<32)|(&0x3000000030000<<38)|(&0xF0000000<<60)],
            174 => [(&0xFF000000FFFFFFFF<<0)|(&0xC0C0C00000000<<2)|(&0x3030300000000<<6)|(&0xC0C0C000000000<<58)|(&0x30303000000000<<62)],
            175 => [(&0xFFFFFFFFFF000000<<0)|(&0xC0C0C<<2)|(&0x30303<<6)|(&0xC0C0C0<<58)|(&0x303030<<62)],
            180 => [(&0xFF00FFFF0000FFFF<<0)|(&0x30000<<6)|(&0x3C0000<<10)|(&0xF0000000<<22)|(&0x3000000C00000<<32)|(&0x3C000000000000<<38)|(&0xC000000F000000<<58)],
            182 => [(&0xFF000000FFFFFFFF<<0)|(&0x30033000000000<<2)|(&0x30C0300000000<<4)|(&0xC030C000000000<<60)|(&0xCC00C00000000<<62)],
            183 => [(&0xFFFFFFFFFF000000<<0)|(&0x33003<<2)|(&0xC030C<<4)|(&0x30C030<<60)|(&0xC00CC0<<62)],
        ]);
        let c_o = crate::lut::update_orientations_u32(c_o, {
            static LUT: [[u32; 3]; 184] = [
